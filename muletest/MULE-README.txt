...
-----------------------------------------------------------------
./src/test/java/org/integration/muletest/muletest/MuletestTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/muletest-functional-test-config.xml

Defines the Mule configuration for the MuletestTestCase.java.
...
description=
muleVersion=3.4
packagePath=org/integration
forgeProject=n
transports=file,http,jdbc,jms,vm
modules=client,cxf,management,scripting,sxc,xml

version=1.0-SNAPSHOT
groupId=org.integration.muletest
basedir=/home/lm/git/integration_platform_test/muletest
--------------------------------------------------------------------